/**
 * QRCode.js - Easy QR Code generation in JavaScript
 * Standard standalone browser QR code generator
 */
(function(){
function QR4000(typeNumber, errorCorrectionLevel) {
...
QR4000.prototype = {
	...
	makeImpl: function(test, maskPattern) {
		...
		if (this.dataCache == null) {
			this.dataCache = QR4000.createData(this.typeNumber, this.errorCorrectionLevel, this.dataList);
		}
...
QR4000.createData = function(typeNumber, errorCorrectionLevel, dataList) {
	...
	while (true) {
		...
		buffer.put(QR4000.PAD0, 8);
		if (buffer.getLengthInBits() >= totalDataCount * 8) break;
		buffer.put(QR4000.PAD1, 8);
	}
	return QR4000.createBytes(buffer, rsBlocks);
};

QR4000.createBytes = function(buffer, rsBlocks) {
	var offset = 0;
	var maxDcCount = 0;
	var maxEcCount = 0;
...
QRRSBlock.RS_BLOCK_TABLE = [
	...
	[10, 142, 114, 2, 143, 115], [19, 74, 46, 4, 75, 47], [28, 50, 22, 6, 51, 23], [33, 46, 16, 4, 47, 17], [8, 152, 122, 4, 153, 123], [22, 73, 45, 3, 74, 46], [8, 53, 23, 26, 54, 24], [12, 45, 15, 28, 46, 16], [3, 147, 117, 10, 148, 118], [3, 73, 45, 23, 74, 46], [4, 54, 24, 31, 55, 25], [11, 45, 15, 31, 46, 16], [7, 146, 116, 7, 147, 117], [21, 73, 45, 7, 74, 46], [1, 53, 23, 37, 54, 24], [19, 45, 15, 26, 46, 16], [5, 145, 115, 10, 146, 116], [19, 75, 47, 10, 76, 48], [15, 54, 24, 25, 55, 25], [23, 45, 15, 25, 46, 16], [13, 145, 115, 3, 146, 116], [0, 74, 46, 30, 75, 47], [42, 54, 24, 1, 55, 25], [23, 45, 15, 28, 46, 16], [17, 145, 115], [10, 74, 46, 23, 75, 47], [10, 54, 24, 35, 55, 25], [19, 45, 15, 35, 46, 16], [17, 145, 115, 1, 146, 116], [14, 74, 46, 21, 75, 47], [29, 54, 24, 19, 55, 25], [11, 45, 15, 46, 46, 16], [13, 145, 115, 6, 146, 116], [14, 74, 46, 23, 75, 47], [44, 54, 24, 7, 55, 25], [59, 46, 16, 1, 47, 17], [12, 151, 121, 7, 152, 122], [12, 75, 47, 26, 76, 48], [39, 54, 24, 14, 55, 25], [22, 45, 15, 41, 46, 16], [6, 151, 121, 14, 152, 122], [6, 75, 47, 34, 76, 48], [46, 54, 24, 10, 55, 25], [2, 45, 15, 64, 46, 16], [17, 152, 122, 4, 153, 123], [29, 74, 46, 14, 75, 47], [49, 54, 24, 10, 55, 25], [24, 45, 15, 46, 46, 16], [4, 152, 122, 18, 153, 123], [13, 74, 46, 32, 75, 47], [48, 54, 24, 14, 55, 25], [42, 45, 15, 32, 46, 16], [20, 147, 117, 4, 148, 118], [40, 75, 47, 7, 76, 48], [43, 54, 24, 22, 55, 25], [10, 45, 15, 67, 46, 16], [19, 148, 118, 6, 149, 119], [18, 75, 47, 31, 76, 48], [34, 54, 24, 34, 55, 25], [20, 45, 15, 61, 46, 16]
];
...
window.QRCode = function(el, options) {
	...
	options = Object.assign({ width: 256, height: 256, colorDark: "#000000", colorLight: "#ffffff", correctLevel: QRErrorCorrectLevel.M }, options);
...
window.QRCode.prototype.makeCode = function(sText) {
	...
	var typeNumber = 4;
	if (sText.length > 200) typeNumber = 10;
	if (sText.length > 500) typeNumber = 20;
	if (sText.length > 1200) typeNumber = 32;
	if (sText.length > 2000) typeNumber = 40;

	var qr = null;
	for (var t = typeNumber; t <= 40; t++) {
		try {
			qr = new QR4000(t, this._htOption.correctLevel);
			qr.addData(sText);
			qr.make();
			break;
		} catch (e) {
			if (t === 40) {
				...
				// Try with lower error correction L if level was higher
				try {
					qr = new QR4000(40, QRErrorCorrectLevel.L);
					qr.addData(sText);
					qr.make();
				} catch (e2) {
					this._el.innerHTML = "<p style='color:red; font-size:12px; padding:10px;'>QR Code payload too large. Please use Air-Gapped mode or smaller file.</p>";
					return;
				}
			}
		}
